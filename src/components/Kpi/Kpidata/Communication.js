...
import DropdownforCommunication from "../KpiTables/components/DropdownforCommunication";
import DropdownforOperation from "../KpiTables/components/DropdownforOperation"
...
const Communication = () => {
  ...
  return (
    <>
       ...
       <DropdownforCommunication onSelect={handleDropdownSelect}/>
       </div>
       
        <CommunicationDataTable category={selectedCategory} subcategory={selectedSubcategory} newOption={selectedNewOption} />
      </div>
