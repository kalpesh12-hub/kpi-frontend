...
import SalesDataTable from "../KpiTables/components/SalesDataTable";
import { Container } from "rsuite";
import DropdownforFinance from "../KpiTables/components/DropdownforFinance";
import DropdownforSales from "../KpiTables/components/DropdownforSales"
...
const Sales = () => {
  ...
  return (
   ...
   <div>
      ...
      <DropdownforSales onSelect={handleDropdownSelect}/>
      </div>
       
       < SalesDataTable category={selectedCategory} subcategory={selectedSubcategory} newOption={selectedNewOption} />
     </div>
