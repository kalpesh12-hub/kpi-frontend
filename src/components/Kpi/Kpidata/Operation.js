...
import OperationDataTable from "../KpiTables/components/OperationDataTable";
import { Container } from "rsuite";
import DropdownforOpreation from "../KpiTables/components/DropdownforOperation";
...
const Operation = () => {
  ...
  return (
   ...
   <div>
        ...
        <DropdownforOpreation onSelect={handleDropdownSelect}/>
        </div>
      
        <OperationDataTable category={selectedCategory} subcategory={selectedSubcategory} newOption={selectedNewOption} />
      </div>
