...
import MarketingDatatable from "../KpiTables/components/MarketingDatatable";
import { Container } from "rsuite";
import DropdownforMarketing from "../KpiTables/components/DropdownforMarketing";
...
const Marketing = () => {
  ...
  return (
   ...
   <div>
        ...
        <DropdownforMarketing onSelect={handleDropdownSelect}/>
        </div>
      
        <MarketingDatatable category={selectedCategory} subcategory={selectedSubcategory} newOption={selectedNewOption} />
      </div>
