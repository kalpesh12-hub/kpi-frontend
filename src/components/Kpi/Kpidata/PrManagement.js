...
import PrmanagementTable from "../KpiTables/components/PrmanagementTable";
import { Container } from "rsuite";
import DropdownforPrMangement from "../KpiTables/components/DropdownforPrMangement";
...
const PrManagement = () => {
  ...
  return (
   ...
   <div>
        ...
        <DropdownforPrMangement onSelect={handleDropdownSelect}/>

        </div>
       
        <PrmanagementTable category={selectedCategory} subcategory={selectedSubcategory} newOption={selectedNewOption} />
      </div>
